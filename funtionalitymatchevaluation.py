...
def functionalEvaluation():
    ...
    for m in range(len(cloneOutput)):
        ...
        top1, top3, top5, top10, mrr = calculateFunctionalMetrics(gtFuncationalId[0], topKFuncationalId)
        mrrList.append(mrr)
        ...
        with open(foldername + "funationalitymatch.txt", "a", encoding="utf-8") as outfile:
